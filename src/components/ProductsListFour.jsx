  ...
  if (isLoading) {
    return (
      <Flex justify="center" align="center" gap={10} my={50}>
        ...
        <Text c="#7000FF" size="15px">Issiq Texnika tovarlari yuklanmoqda...</Text>
      </Flex>
    );
  }
  ...
  return (
    <Box mb={60}>
      ...
      <Flex justify="center" mt={25}>
        <Link to="/category/issiqTexnika" style={{ textDecoration: "none" }}>
          <Button
            variant="light"
            color="gray"
            radius="md"
          ...
          >
            Barcha "Issiq Texnika" mahsulotlarini ko'rish ({products?.length || 0})
          </Button>
        </Link>
      </Flex>
    </Box>
