...
import { fetchPriductsFour } from "../api/productsApi";
...
export default function ProductsListFour() {
  ...
  const toggleWishList = (item) => {
    const bormmm = wishList.some((mahs) => mahs.id === item.id);
  ...
  return (
    <div>
      <List>
        <Title c={"#1f2026b9"} mt={80} mb={30}>
          Issiq Texnika <FaChevronRight size={22} />
        </Title>
                ...
                <Flex justify={"space-between"} align={"end"}>
                  ...
                  <button
                    ...
                    style={{
                      ...
                      borderRadius: "80px",
                      background:
                        hoverFunc == item.id ? "rgba(0, 0, 0, 0.1)" : "none",
                      border: "none",
                      cursor: "pointer",
                      transition: "0.2s",
                    }}
