...
export default function ProductsListThree() {
  ...
  if (isLoading) {
    return (
      <Flex justify="center" align="center" gap={10} my={50}>
        ...
        <Text c="#7000FF" size="15px">Muddatli to'lov tovarlari yuklanmoqda...</Text>
      </Flex>
    );
  }
  ...
  return (
    <Box mb={45}>
      ...
      <Flex justify="center" mt={25}>
        <Link to="/category/muddatliTolov" style={{ textDecoration: "none" }}>
          <Button
            variant="light"
            color="gray"
            radius="md"
          ...
          >
            Barcha "Muddatli to'lov" mahsulotlarini ko'rish ({products?.length || 0})
          </Button>
        </Link>
      </Flex>
    </Box>
